...
const WorkshopUpdate = ({
  ...
  dataDetail?: WorkshopDetailInterface;
}) => {
  ...
  const handleSubmit = async (value: any) => {
    ...
    await Promise.all([
      handleUpdateWorkshop({ ...value, date: formattedDate }),
  ...
  const initialValues = dataDetail
    ? {
        ...
        speaker: dataDetail.speaker.id,
        courses: dataDetail.courses.map((course) => course.id),
